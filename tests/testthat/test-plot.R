context("bigimp plot function tests")
...
######################
print("Function being tested: imp_plot_aggregations")

test_that("imp_plot_aggregations", {
...
######################
print("Function being tested: imp_plot_bw")

test_that("imp_plot_bw", {
  }
  )
######################
...
######################
print("Function being tested: imp_plot_convergence")

test_that("imp_plot_convergence", {
  }
  )
######################
...
######################
print("Function being tested: imp_plot_density")

test_that("imp_plot_density", {
  }
  )
######################
...
######################
print("Function being tested: imp_plot_missingness")

test_that("imp_plot_missingness", {
  }
  )
######################
...
######################
print("Function being tested: imp_plot_strip")

test_that("imp_plot_strip", {
  }
  )
######################
