context("bigimp imputation function tests")
...
######################
print("Function being tested: imp_imp_dry_run")

test_that("imp_imp_dry_run", {
...
######################
print("Function being tested: imp_imp_mice")

test_that("imp_imp_mice", {
  }
  )
######################
